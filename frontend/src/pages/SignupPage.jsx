...
import ChattingIllustration from "../assets/chatting-cuate.svg"
      ...
      <div className="relative w-full max-w-6xl md:h-[800px] h-[95vh]">
        <BorderAnimatedContainer className="p-5">
          <div className="w-full h-full flex flex-col md:flex-row">
            ...
            <div className="md:w-1/2 md:p-8 flex items-center justify-center md:border-r border-r-gray-200/15">
            ...
            <div className="hidden md:w-1/2 md:flex items-center justify-center p-6">
              <div>
                ...
                />
                <div className="mt-6 text-center">
                  <h3 className="text-xl font-medium text-gray-200">Start Your Journey Today</h3>
