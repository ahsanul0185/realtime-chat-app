...
const NoChatHistory = ({name}) => {
  return (
     <div className="flex flex-col items-center justify-center h-full text-center p-6">
      <div className="w-16 h-16 bg-linear-to-br from-primary/20 to-primary/10 rounded-full flex items-center justify-center mb-5">
      ...
      <div className="flex flex-col space-y-3 max-w-md mb-5">
        ...
        <div className="h-px w-32 bg-linear-to-r from-transparent via-primary/30 to-transparent mx-auto"></div>
      </div>
